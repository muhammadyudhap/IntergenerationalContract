...
I1       = (1 - alpha) * Ze0 * (alpha * k1n^rho + (1 - alpha))^( (1 - rho)/ rho )*...
    (1 - ( alpha/(1 - alpha) ) * k1n^rho * tauo1 );
...
I1      = (1 - alpha) * Ze0 * (alpha * k1s^rho + (1 - alpha))^( (1 - rho)/ rho )*...
    (1 - ( alpha/(1 - alpha) ) * k1s^rho * tauo1s );
