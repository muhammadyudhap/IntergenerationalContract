...
%% 
 guesstmt  = 0.01;
for i = 1:N
    parameters(16) = i*di; %simulating pollution rate zeta
...
%% figure
h = figure;
plot(Polrate,mtvec,'-','LineWidth',2,'Color','blue');
hold on;
plot(Polrate,mtvec2,'--','LineWidth',2,'Color','red');
legend({'Capital Subsidy','Lump-sum'},'Interpreter','latex','FontSize',14,'Location','northwest');
xlabel('Pollution Rate $\xi$','Interpreter','latex','FontSize',14,'Color','black');
...
%print(h,'pollution_mt_cobb.pdf','-dpdf','-r0');